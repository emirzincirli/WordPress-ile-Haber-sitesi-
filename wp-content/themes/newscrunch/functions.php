	    ...
	    <div class="newscrunch-update-notice notice notice-info is-dismissible">
	        <div class="notice-content-wrap">
	        	<div class="admin-update-img">
	                <img src="<?php echo esc_url(get_theme_file_uri().'/admin/assets/img/Date-Formation.png');?>" alt="<?php esc_attr_e('Notice Image','newscrunch'); ?>"/>
	            </div>
	            <div class="notice-content">
	                ...
	                <ol class="admin-notice-up-list">
	                    <li><?php echo esc_html__('Added date formatting feature', 'newscrunch' ); ?></li>
	                    <li><?php echo esc_html__('Updated font-awesome library', 'newscrunch' ); ?></li>
	                </ol>
